            ...
            <div class="grid grid-cols-7">
                ...
                <div class="col-span-5 overflow-hidden">
                    ...
                    <span class="font-bold text-justify">
                        At least one author of every accepted paper is mandatorily required to register before given deadline. The registered author must present the paper in the Conference. Accepted papers will be submitted for inclusion into IEEE Xplore subject to meeting IEEE Xplore’s scope and quality requirements
                    </span><br><br>
                    ...
                    <div class="p-5">
                        <ul class="list-disc text-justify">
                            ...
                            <li class="my-2">Kindly download and fill the <b><a href="#">Registration Form</a>(Coming soon)</b> and
                                complete your registration through <b><a href="#" target="_blank">Register Now</a>(Coming soon)</b>, irrespective of the mode of payment.</li>
